#
# Be sure to run `pod lib lint PDRatingsController.podspec' to ensure this is a
...
4. Rest will taken care of by this class.'
  ...
  s.source_files = 'PDRatingsController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'PDRatingsController' => ['PDRatingsController/Assets/*.png']
  # }
